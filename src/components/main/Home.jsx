...
const fetchMultipleTables = async (tables) => {
  let combinedData = [];
...
export const Home = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      setMaleBasketball(await fetchMultipleTables(["basketball_itc", "emongolia_basketball"]));
      setFemaleBasketball(await fetchMultipleTables(["basketball_itc_female", "emongolia_basketball_female"]));
      setMaleVolleyball(await fetchMultipleTables(["volleyball_itc", "emongolia_volleyball"]));
      setFemaleVolleyball(await fetchMultipleTables(["volleyball_itc_female", "emongolia_volleyball_female"]));
    };
    fetchData();
  }, []);
